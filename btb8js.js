...
/*let a=prompt("nhap so thu1:");
let b=prompt("nhap so thu2:");
let aNumber = parseFloat(a);
let bNumber = parseFloat(b);
if(aNumber>bNumber){console.log(`so thu1 (${aNumber}) lon hon so thu2 (${bNumber}`);}
else if (bNumber>aNumber){console.log(`So thu2 (${bNumber}) lon hon so thu1 (${aNumber})`);}
...
/*let toanTu= prompt("Nhập vào phép tính: +,-,*,/");
